...
func (c *FakeCells) Get(name string, options v1.GetOptions) (result *v1beta2.Cell, err error) {
	obj, err := c.Fake.
...
func (c *FakeCells) List(opts v1.ListOptions) (result *v1beta2.CellList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCells) Create(cell *v1beta2.Cell) (result *v1beta2.Cell, err error) {
	obj, err := c.Fake.
...
func (c *FakeCells) Update(cell *v1beta2.Cell) (result *v1beta2.Cell, err error) {
	obj, err := c.Fake.
...
func (c *FakeCells) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(cellsResource, name), &v1beta2.Cell{})
	return err
}
...
func (c *FakeCells) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Cell, err error) {
	obj, err := c.Fake.
