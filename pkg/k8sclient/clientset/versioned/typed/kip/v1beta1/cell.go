...
type CellInterface interface {
	Create(ctx context.Context, cell *v1beta1.Cell, opts v1.CreateOptions) (*v1beta1.Cell, error)
	Update(ctx context.Context, cell *v1beta1.Cell, opts v1.UpdateOptions) (*v1beta1.Cell, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.Cell, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.CellList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Cell, err error)
	CellExpansion
}
...
func (c *cells) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Cell, err error) {
	result = &v1beta1.Cell{}
	err = c.client.Get().
		Resource("cells").
		Name(name).
...
func (c *cells) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.CellList, err error) {
...
func (c *cells) Create(ctx context.Context, cell *v1beta1.Cell, opts v1.CreateOptions) (result *v1beta1.Cell, err error) {
	result = &v1beta1.Cell{}
	err = c.client.Post().
		Resource("cells").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *cells) Update(ctx context.Context, cell *v1beta1.Cell, opts v1.UpdateOptions) (result *v1beta1.Cell, err error) {
	result = &v1beta1.Cell{}
	err = c.client.Put().
		Resource("cells").
		Name(cell.Name).
...
func (c *cells) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Cell, err error) {
	result = &v1beta1.Cell{}
