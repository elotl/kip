...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodDedicated) DeepCopyInto(out *PodDedicated) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodDedicated.
func (in *PodDedicated) DeepCopy() *PodDedicated {
	if in == nil {
		return nil
	}
	out := new(PodDedicated)
	in.DeepCopyInto(out)
	return out
}
